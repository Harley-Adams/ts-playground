...
import { Dialog, Button, DialogType, DialogFooter, ChoiceGroup, ButtonType } from 'office-ui-fabric-react';

export default class OfficeDialogExample extends React.Component<any, any> {
